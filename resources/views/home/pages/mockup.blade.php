    ...
    <div class="container mockup">
        ...
        <div class="row mb-5 mt-2">
            <div class="col-12 mockup-image">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-43.png')}}" class="card-img-top" >
                <div class="overlap">
                    <img src="{{URL::to('users/assets/images/products/1/Rectangle-40.png')}}" class="card-img-top" >
                </div>
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-45.png')}}" class="card-img-top" >
            </div>
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-42.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-12">
        ...
        <div class="row mb-5 mt-5">
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-44.png')}}" class="card-img-top" >
            </div>
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-41.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-12">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-46.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-47.png')}}" class="card-img-top" >
            </div>
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-48.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-12">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-49.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-50.png')}}" class="card-img-top" >
            </div>
            <div class="col-6">
                <img src="{{URL::to('users/assets/images/products/1/Rectangle-51.png')}}" class="card-img-top" >
            </div>
        </div>
        <div class="row mb-5 mt-5">
            <div class="col-12">
