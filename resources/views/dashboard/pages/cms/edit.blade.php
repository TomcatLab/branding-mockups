      ...
      <div class="card">
        <div class="card-body">
            ...
            <div class="col-6">
              <div class="form-check form-check-inline">
                <label class="form-check-label">
                  <input type="checkbox" class="form-check-input" name="Home" value="banners" >
                    Home
          ...
          <div class="form-group banner-slider-option" id="banners">
            ...
            <select class="form-control action" id="Banner" name="Banner">
          ...
          <div class="form-group banner-slider-option d-none" id="sliders">
            ...
            <select class="form-control action" id="Slider" name="Slider">
